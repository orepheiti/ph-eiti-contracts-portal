...
*/
$url = "https://api.resourcecontracts.org/contracts/search?q=&from=0&per_page=10000&group=metadata&country_code=ph";
...
foreach ($results as $r) {
  ...
  $contract_url = "https://api.resourcecontracts.org/contracts/" . $r->id . "/metadata";
